...
namespace diyou计算器
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("author：diyou（sotl studio）\nNote: this project is only developed by diyou.", "author", MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
        ...
        {   
            ...
            {
                MessageBox.Show("Input incomplete!\nPlease add the number!", "error", MessageBoxButtons.OK,MessageBoxIcon.Error);
            }
            else
            {
        ...
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Exclusive_or");
        }
